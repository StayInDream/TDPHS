...
namespace FairyGUI
{
    ...
    /// 
    /// </summary>
    public class GTextField : GComponent, IColorGear
    {
        /// <summary>
        /// 
        /// </summary>
            ...
            : base()
        {
            ...
            MM = new EventListener( this, "onClick" );
            //Container con = new Container();
            //con.SetSize( this.width, this.height );
            //con.gOwner = this;
            //displayObject = con;
            //displayObject.onClick.Add(TextOnClck); 
        }

        private void TextOnClck( EventContext context )
        {
            Debug.Log( "44555555" );
        }
        ...
        override protected void CreateDisplayObject()
        {
            ...
            displayObject.onClick.Add( textOnclick );
        }

        private void textOnclick( EventContext context )
        {
