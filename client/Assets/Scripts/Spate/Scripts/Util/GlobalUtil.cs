...
public class GlobalUtil
{
    ...
    #endregion
    #region Dreamland
    public const int DL_OPEN_TIME = 30 * 60; //持续时间
    //public const int DL_CLOSE_TIME = 30 * 60; //关闭CD时间
    //public const int DL_COOLING_TIME = 10 * 60;// 冷却CD时间
    #endregion
    #region 订单号
    public static string OrderId = "";
    public static int PaySucConfirmTimes = 0;
    #endregion
    ...
    /// 阵容英雄互换
    /// </summary>
    public const string TEAM_HERO_SWAP = "team_hero_swap";
    /// <summary>
    /// 英雄上阵下阵
    /// </summary>
    public const string TEAM_HERO_OUTIN = "team_hero_outin";
    /// <summary>
    /// CDkey输入错误
    /// </summary>
    ...
    /// Role信息pid更新
    /// </summary>
    public const string ROLESVRHEROUPDATE = "RoleSvrHeroUpdate";
    /// <summary>
    /// 英雄数据更新
    /// </summary>
    ...
    /// 跨天通知
    /// </summary>
    public const string ACROSS_THE_DAY = "Across_The_Day";
    ...
    /// 进度表数据更新
    /// </summary>
    public const string PROGRESS_UPDATE = "Progress_Update";
    /// <summary>
    /// 玩法次数购买成功
    /// </summary>
    public const string GAME_TIMES_BUY = "Game_Times_Buy";
    //
    public const string MINE_ERROR_30032 = "Mine_Error_30032";
    public const string MINE_ERROR_30033 = "Mine_Error_30033";
    #endregion

    #region Static
    public static DateTime Mall_Refresh_Time;
  
    public static int Stage_Dfficult = 1;
    #endregion

    #region Mine
    public const int MINE_TOTAL_NUM = 50;//金矿的总数量 
    public static int MINE_PAGE_NUM = 10;//每一页显示的数量 
    public const int OCCUPY_TIMES = 3;//每个矿可被掠夺的次数
    public const int OCCUPY_TOTAL_TIME = 8 * 60 * 60; //占矿时间
    public const int MINE_REFRESH_TIME = 5 * 60; //定时刷新时间
    public static DateTime Mine_Refresh_Time;
    #endregion

    #region 商店
    public static DateTime openCommonTime;
    public  static  DateTime openTowerTime;
    public static DateTime openBodukaiTime;
    public static DateTime openFriendShopTime;
    #endregion
